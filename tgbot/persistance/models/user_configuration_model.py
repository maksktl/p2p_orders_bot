from sqlalchemy import sql, Column, String, ARRAY, BIGINT
...
class UserConfigurationModel(TimedBaseModel):
    ...
    deposit = Column(BIGINT, nullable=False)
    spread_from = Column(BIGINT, nullable=False)
    spread_to = Column(BIGINT, nullable=False)
